...
The first one hosts the applications like in the ``stackit-kms`` example.
The second one hosts a single Hashicorp Vault instance where the first one sends its requests for en- and decryption to.
